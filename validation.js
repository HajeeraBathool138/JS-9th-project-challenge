...
form.addEventListener('submit', (e) => {
  ...
  if (errors.length > 0) {
    ...
    if (firstname_input) {
      console.log('Firstname:', firstname_input.value);
    ...
    // Check local storage after setting values
...
console.log("Retrieved from local storage:", { storedFirstname, storedEmail });